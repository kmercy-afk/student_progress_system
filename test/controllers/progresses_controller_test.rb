...
class ProgressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create progress" do
    assert_difference('Progress.count') do
      post progresses_url, params: { progress: { completion_percentage: @progress.completion_percentage, course_id: @progress.course_id, status: @progress.status, student_id: @progress.student_id } }
    end
  ...
  test "should update progress" do
    patch progress_url(@progress), params: { progress: { completion_percentage: @progress.completion_percentage, course_id: @progress.course_id, status: @progress.status, student_id: @progress.student_id } }
